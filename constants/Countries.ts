...
export const countries: Country[] = [
  ...
  {name: 'American Samoa', code: 'AS', callingCode: '+1', flag: '🇦🇸'},
  {name: 'Andorra', code: 'AD', callingCode: '+376', flag: '🇦🇩'},
  {name: 'Angola', code: 'AO', callingCode: '+244', flag: '🇦🇴'},
  {name: 'Anguilla', code: 'AI', callingCode: '+1', flag: '🇦🇮'},
  {name: 'Antigua & Barbuda', code: 'AG', callingCode: '+1', flag: '🇦🇬'},
  ...
  {name: 'Ascension Island', code: 'AC', callingCode: '+247', flag: '🇦🇨'},
  ...
  {name: 'Caribbean Netherlands', code: 'BQ', callingCode: '+599', flag: '🇧🇶'},
  {name: 'Cayman Islands', code: 'KY', callingCode: '+1', flag: '🇰🇾'},
  {name: 'Central African Republic', code: 'CF', callingCode: '+236', flag: '🇨🇫'},
  {name: 'Chad', code: 'TD', callingCode: '+235', flag: '🇹🇩'},
  {name: 'Chagos Archipelago', code: 'IO', callingCode: '+246', flag: '🇮🇴'},
  {name: 'Chile', code: 'CL', callingCode: '+56', flag: '🇨🇱'},
  {name: 'China mainland', code: 'CN', callingCode: '+86', flag: '🇨🇳'},
  {name: 'Christmas Island', code: 'CX', callingCode: '+61', flag: '🇨🇽'},
  {name: 'Cocos (Keeling) Islands', code: 'CC', callingCode: '+61', flag: '🇨🇨'},
  {name: 'Colombia', code: 'CO', callingCode: '+57', flag: '🇨🇴'},
  {name: 'Comoros', code: 'KM', callingCode: '+269', flag: '🇰🇲'},
  {name: 'Congo - Brazzaville', code: 'CG', callingCode: '+242', flag: '🇨🇬'},
  {name: 'Congo - Kinshasa', code: 'CD', callingCode: '+243', flag: '🇨🇩'},
  ...
  {name: 'Côte d’Ivoire', code: 'CI', callingCode: '+225', flag: '🇨🇮'},
  {name: 'Denmark', code: 'DK', callingCode: '+45', flag: '🇩🇰'},
  {name: 'Djibouti', code: 'DJ', callingCode: '+253', flag: '🇩🇯'},
  {name: 'Dominica', code: 'DM', callingCode: '+1', flag: '🇩🇲'},
  {name: 'Dominican Republic', code: 'DO', callingCode: '+1', flag: '🇩🇴'},
  ...
  {name: 'Grenada', code: 'GD', callingCode: '+1', flag: '🇬🇩'},
  {name: 'Guadeloupe', code: 'GP', callingCode: '+590', flag: '🇬🇵'},
  {name: 'Guam', code: 'GU', callingCode: '+1', flag: '🇬🇺'},
  {name: 'Guatemala', code: 'GT', callingCode: '+502', flag: '🇬🇹'},
  {name: 'Guernsey', code: 'GG', callingCode: '+44', flag: '🇬🇬'},
  ...
  {name: 'Heard & McDonald Islands', code: 'HM', callingCode: '+672', flag: '🇭🇲'},
  ...
  {name: 'Isle of Man', code: 'IM', callingCode: '+44', flag: '🇮🇲'},
  {name: 'Israel', code: 'IL', callingCode: '+972', flag: '🇮🇱'},
  {name: 'Italy', code: 'IT', callingCode: '+39', flag: '🇮🇹'},
  {name: 'Jamaica', code: 'JM', callingCode: '+1', flag: '🇯🇲'},
  {name: 'Japan', code: 'JP', callingCode: '+81', flag: '🇯🇵'},
  {name: 'Jersey', code: 'JE', callingCode: '+44', flag: '🇯🇪'},
  ...
  {name: 'Kosovo', code: 'XK', callingCode: '+377', flag: '🇽🇰'},
  ...
  {name: 'Macao', code: 'MO', callingCode: '+853', flag: '🇲🇴'},
  ...
  {name: 'Myanmar (Burma)', code: 'MM', callingCode: '+95', flag: '🇲🇲'},
  ...
  {name: 'Palestine Territories', code: 'PS', callingCode: '+970', flag: '🇵🇸'},
  ...
  {name: 'Puerto Rico', code: 'PR', callingCode: '+1939', flag: '🇵🇷'},
  ...
  {name: 'Sint Maarten', code: 'SX', callingCode: '+1', flag: '🇸🇽'},
  {name: 'Slovakia', code: 'SK', callingCode: '+421', flag: '🇸🇰'},
  {name: 'Slovenia', code: 'SI', callingCode: '+386', flag: '🇸🇮'},
  {name: 'So. Georgia & So. Sandwich Isl.', code: 'GS', callingCode: '+500', flag: '🇬🇸',},
  ...
  {name: 'St. Barthelemy', code: 'BL', callingCode: '+590', flag: '🇧🇱'},
  {name: 'St. Helena', code: 'SH', callingCode: '+290', flag: '🇸🇭'},
  {name: 'St. Kitts & Nevis', code: 'KN', callingCode: '+1', flag: '🇰🇳'},
  {name: 'St. Lucia', code: 'LC', callingCode: '+1', flag: '🇱🇨'},
  {name: 'St. Martin', code: 'MF', callingCode: '+590', flag: '🇲🇫'},
  {name: 'St. Pierre & Miquelon', code: 'PM', callingCode: '+508', flag: '🇵🇲'},
  {name: 'St. Vincent & Grenadines', code: 'VC', callingCode: '+1', flag: '🇻🇨'},
  {name: 'Sudan', code: 'SD', callingCode: '+249', flag: '🇸🇩'},
  {name: 'Suriname', code: 'SR', callingCode: '+597', flag: '🇸🇷'},
  {name: 'Svalbard & Jan Mayen', code: 'SJ', callingCode: '+47', flag: '🇸🇯'},
  ...
  {name: 'São Tomé & Príncipe', code: 'ST', callingCode: '+239', flag: '🇸🇹'},
  ...
  {name: 'Trinidad & Tobago', code: 'TT', callingCode: '+1', flag: '🇹🇹'},
  ...
  {name: 'Turks & Caicos Islands', code: 'TC', callingCode: '+1', flag: '🇹🇨'},
  {name: 'Tuvalu', code: 'TV', callingCode: '+688', flag: '🇹🇻'},
  {name: 'U.S Virgin Islands', code: 'VI', callingCode: '+1', flag: '🇻🇮'},
  ...
  {name: 'Wallis & Futuna', code: 'WF', callingCode: '+681', flag: '🇼🇫'},
  {name: 'Western Sahara', code: 'EH', callingCode: '+212', flag: '🇪🇭'},
